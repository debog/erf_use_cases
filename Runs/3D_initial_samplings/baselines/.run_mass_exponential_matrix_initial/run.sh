#!/bin/bash
#
# Run script for initial sampling case: mass_exponential
# Platform: matrix
# Generated by run_erf.sh on Thu Jan 29 16:24:55 PST 2026
#
...
INPUT=inputs_mass_exponential

echo "Running ERF for initial sampling (max_step = 0)"
echo "Case: mass_exponential"
