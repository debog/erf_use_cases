#!/bin/bash
#
# Run script for initial sampling case: mass_exponential_sampled
# Platform: matrix
# Generated by run_erf.sh on Thu Jan 29 16:27:18 PST 2026
#
...
INPUT=inputs_mass_exponential_sampled

echo "Running ERF for initial sampling (max_step = 0)"
echo "Case: mass_exponential_sampled"
