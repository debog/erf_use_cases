#!/bin/bash
#
# Run script for initial sampling case: radius_log_normal_sampled
# Platform: matrix
# Generated by run_erf.sh on Thu Jan 29 16:28:02 PST 2026
#
...
INPUT=inputs_radius_log_normal_sampled

echo "Running ERF for initial sampling (max_step = 0)"
echo "Case: radius_log_normal_sampled"
