#!/bin/bash
#
# Run script for initial sampling case: radius_lognormal_autorange_sampled
# Platform: matrix
# Generated by run_erf.sh on Thu Jan 29 16:29:15 PST 2026
#
...
echo "Case: radius_lognormal_autorange_sampled"
